    ...
    return Material(
     // color: Colors.black.withOpacity(.55),
      child:  Container(height: MediaQuery.of(context).size.height,
          //assets/4.0x/background.png
          decoration: BoxDecoration(
            image: DecorationImage(
              image: AssetImage("assets/4.0x/background.png"),
              fit: BoxFit.cover,
            ),
          ),
          ...
          child: Column(
            ...
            children: <Widget>[
              ...
              Container(height: 200,width: 200,
                  child: Image.network(matchedUser.userProfilePhoto))),
             ...
             /* Text(matchedUser.userFullname.split(" ")[0],
              ...
              Text("${i18n.translate("likes_you_too ")}${matchedUser.userFullname.split(" ")[0]}",
                  style: TextStyle(
                      fontSize: 25,
