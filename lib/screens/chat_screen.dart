...
import 'package:dating_app/api/CallingAPI.dart';
...
import 'package:dating_app/datas/user.dart' as w;

import 'package:dating_app/dialogs/common_dialogs.dart';
import 'package:dating_app/dialogs/progress_dialog.dart';
import 'package:dating_app/helpers/app_localizations.dart';
import 'package:dating_app/models/user_model.dart';
import 'package:dating_app/screens/Call/models/UserModel.dart' as User;
...
import 'Call/PickupLayout.dart';
import 'Call/components/Permissions.dart';
import 'Call/utilites/AppConstants.dart';
...
class _ChatScreenState extends State<ChatScreen> with WidgetsBindingObserver{
  bool isRequestAccept = true;
  final UserModel? receiverUser= UserModel();
  // Variables
  final _textController = TextEditingController();
  final _messagesController = ScrollController();
  final CallingApi _callingApi = CallingApi();
  ...
  // Send message
  Future<void> _sendMessage({required String type, String? text, File? imgFile}) async {
    String textMsg = '';
    String imageUrl = '';
 ...
 /* Future<void> onJoin(BuildContext context) async {
    if (widget.user.userId.toString().isNotEmpty) {
     ...
     await Navigator.push(
        ...
        MaterialPageRoute(
          builder: (context) => CallPage(
            ...
            channelName: 'video_call',
          ),
        ),
      );
    }
  }*/
  User.UserModel sender =User.UserModel(
            ...
            actions: <Widget>[
              IconButton(
                ...
                onPressed:
                     () async {
                  print('vikaas');
                  return await Permissions.cameraAndMicrophonePermissionsGranted() ? CallFunctions.dial(context: context,from:sender,to:User.UserModel(
              ...
              IconButton(
                ...
                onPressed: isRequestAccept
                    ? () async {
                  return await Permissions.cameraAndMicrophonePermissionsGranted() ? CallFunctions.voiceDial(context: context,from:sender ,to: sender ) : {};
                }
                    : null,
              ),
