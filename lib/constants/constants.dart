...
///
const String APP_NAME = "Rowdy Baby";
const String App_Slogn="What Are You Dating For?";
const Color APP_PRIMARY_COLOR = Color(0xffde2657);
const Color primarq = Color.fromRGBO(52, 43, 37, 1);
const Color gray = Color.fromRGBO(137, 137, 137, 1);
const Color secoundry2 = Color.fromRGBO(198, 116, 27, 1);
const Color secoundry2Light = Color.fromRGBO(226, 185, 141, 1);
const Color APP_ACCENT_COLOR =  Color(0xffC5204C);
const String APP_VERSION_NAME = "v1.0.0";
const int ANDROID_APP_VERSION_NUMBER = 3; // Google Play Version Number
const int IOS_APP_VERSION_NUMBER = 3;
const APP_ID = "c589bdd37c11406697dd25d59f9e5f03";
const Token = "006c589bdd37c11406697dd25d59f9e5f03IAD9oKZQ7ka3h60d5NyzWcdh81cRCaQsjrQ73X/RUEL00uJyGcsAAAAAIgCtlgAAS1lpYQQAAQDbFWhhAwDbFWhhAgDbFWhhBADbFWhh";
...
const String Called_USER_ID = 'Call';
